...
st.write('''
**The Challenge of Sanctions Effectiveness**. Since Russia's invasion of Ukraine in February 2022, 
         the European Union has imposed extensive sanctions aimed at limiting Russia's economic capacity. 
         However, emerging trade patterns suggest that these measures may be less effective than intended, 
         with evidence of systematic circumvention by neighboring countries.

**The Intermediary Countries**. A clear pattern has emerged: the redirection of trade flows through intermediary countries. These countries share two key characteristics: geographical proximity to Russia and strong existing political and economic ties with Russia.
...
**The phenomenon of "missing trade". Our research focuses on a striking pattern: 
         the emergence of significant discrepancies between what EU countries report as exports to Russia's neighbours and 
         what these neighbours officially report as imports from the EU.
...
**Data Collection**. We collected export data from Eurostat, covering trade flows from EU member states 
         to non-EU countries from 2010 to 2023. We also obtained import data from national statistical agencies of 
         countries such as Kyrgyzstan and Armenia for the same period. 
         Incorporating available Russian import/export statistics, we acknowledge limitations due to data restrictions post-2022.
